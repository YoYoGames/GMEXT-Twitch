...
var _scopes_moderation = [
	...
	TWITCH_SCOPE_MODERATION_READ_BLOCKED_TERMS,
	TWITCH_SCOPE_MODERATION_READ_AUTOMOD_SETTINGS,
	TWITCH_SCOPE_MODERATION_READ_CHAT_SETTINGS,
	...
	TWITCH_SCOPE_MODERATION_MANAGE_BANNED_USERS,
	TWITCH_SCOPE_MODERATION_MANAGE_BLOCKED_TERMS,
	TWITCH_SCOPE_MODERATION_MANAGE_AUTOMOD,
	TWITCH_SCOPE_MODERATION_MANAGE_CHAT_SETTINGS,
...
{
	show_debug_message(text + " " + string(!locked))
	if (!locked)
	switch(text)
	{
...
show_debug_message("-------------")
show_debug_message(_scopes)


twitch_auth(_scopes,,,
			function(_data)
			{
				show_message_async(_data)
