...
twitch_eventsub_create_eventsub_subscription("channel.chat.message",1,_condition,_transport, {}, __twitch_debug_callback_success, __twitch_debug_callback_failure);
